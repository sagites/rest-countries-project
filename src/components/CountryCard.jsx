...
const CountryCard = ({ flag, title, population, region, capital, countryData }) => {
  ...
  return (
    <div onClick={handleClick} className="shadow-lg w-72 lg:w-64 bg-white dark:bg-darkBlueElements overflow-hidden transform transition hover:scale-105 duration-300">
